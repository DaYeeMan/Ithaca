...
Planning decisions, European benchmarks, and visual concepts are approved. Phases 1 and 2 are implemented; `ROADMAP.md` tracks later option families and release hardening.
