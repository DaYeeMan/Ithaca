...
Planning decisions, benchmark conventions, and visual concepts are approved. Phases 1 through 4 are implemented; `ROADMAP.md` tracks Asian options and release hardening.
